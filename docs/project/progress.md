...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T-009 | Review and integrate the Figure 5, Figure 6, and Figure 8 comparisons | In progress | 1 | paper-review |  | Understand what the three figures measure, trace how our outputs were generated, evaluate the paper-versus-ours comparisons, and approve their presentation use. | Figure 8 now has three deliberately separate routes: the 2021 final-file/seven-round benchmark, a primary reconstruction from 351 saved direct fields with the full inverse, and a current-public-FWTW/full-inverse robustness check. The eight-slide method deck documents all three; next decide whether to integrate the primary result into the final submission. | [Review task](tasks/figure5-figure8-review.md); [personal considerations](personal-considerations-saving-inequality.md); [Figure 5 replication](tasks/figure5-replication.md); [Figure 6 replication](tasks/figure6-replication.md); [Figure 8 replication](tasks/figure8-replication.md) |
| T-006 | Produce the compact final replication report | In progress | 2 | writing |  | Preserve the detailed technical report while producing a short replication component that can be combined with the referee report and extension proposal. | `Report/replication_summary.pdf` now provides one page of method/data/results plus three generated comparison figures. Next integrate this verified replication component with the completed referee report and the selected extension without expanding its evidence claims. | [Report task](tasks/final-report.md); [short report](../../Report/README.md) |
| T-008 | Design a feasible extension proposal | In progress | 3 | research-design |  | Determine which debt categories account for saving-rate changes across wealth groups and who ultimately financed them, without overstating an accounting decomposition as causal. | Verified evidence selects two distinct regimes: mortgage borrowing dominates the pre-2008 debt build-up and saving drag, while consumer credit remains relatively more important after mortgage deleveraging. Next complete the exact Figure 6 group-income decomposition, then design a pre-2008 mortgage-credit test and a separate post-2008 consumer-credit split. | [Extension proposal](tasks/extension-proposal.md); [canonical debt-composition design](../../research_extension_idea_2.md); [extension data](../data/debt-composition-extension-data.md) |
...
2. Treat the five-slide debt-composition evidence as an implemented descriptive
   result: pre-2008 mortgage dominance and post-2008 relative consumer-credit
   persistence, not an identified mortgage-credit effect.
3. Add the exact Figure 6 percentile/group-income saving-rate decomposition,
   then integrate one concise two-regime extension slide with the completed
...
| T-005 | Build the final pedagogical presentation | Complete | 2 | presentation |  | Distill the methodology novelty, version audit, reconstructed results, and limitations into one visually coherent course presentation while retaining the topic decks as source modules. | The final editable 17-slide deck combines the condensed theory, data lineage, version boundary, and Figure 1/5/8 comparisons. All slides contain source notes, were inspected at full resolution, and pass the automated overflow and archive checks. | [Presentation task](tasks/pedagogical-presentation.md); [final deck](../../Presentation/5_replication_submission/README.md) |
...
| T-011 | Write the referee report | Complete | 1 | paper-review |  | Produce a constructive 1--1.5-page referee report, plus figures, that assesses the paper's contribution and turns the Figure 6 diagnostics into focused revision requests. | The report recommends revise and resubmit, foregrounds the paper's novelty, requests fixed real-wealth bins and time-resolved saving rates, corrects the heatmap scaling proposal for signed data, bounds the unveiling and valuation assumptions, and requests a version-matched 2025 package. Editable DOCX and submission PDF are reproducibly built from one Markdown source; the PDF contains about 1.5 pages of prose plus one figure page. | [Referee-report task](tasks/referee-report.md); [report source](../../Referee_Report/referee_report.md) |
