...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T-009 | Review and integrate the Figure 5 and Figure 8 comparisons | In progress | 1 | paper-review |  | Understand what the two figures measure, read the relevant 2025 paper sections, trace how our outputs were generated, evaluate the paper-versus-ours comparisons, and approve their presentation use. | Today review Figure 5 as an old-input reconstruction and Figure 8 as a bounded old-unveiling proxy, then record the interpretation and any slide corrections before promoting the comparison panels into the final synthesis. | [Review task](tasks/figure5-figure8-review.md); [Figure 5 replication](tasks/figure5-replication.md); [Figure 8 replication](tasks/figure8-replication.md) |
...
1. Read the July 2025 passages around Figure 5 and Figure 8, define every plotted
   object, unit, sign, group, normalization, base year, and moving average, and
   explain the economic conclusion of each figure in plain language.
2. Trace the two Python builds from supplied input files through aggregation,
   valuation or unveiling, national-income scaling, and comparison metrics.
   Verify the saving-closure invariant for Figure 5 and the net-debt identity
   and 1982 zero base for Figure 8.
