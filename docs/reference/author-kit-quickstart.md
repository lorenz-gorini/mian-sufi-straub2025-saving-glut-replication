...
| --- | --- | --- | --- |
| Figure 1: assets behind the intermediation veil | `fof/LQpanel_2019Q1.dta`, selected old allocations, CRSP support, national income | Completed 27-sector/34-instrument matrices, revised corporate-equity extension, and exact denominator are absent | Existing old-vintage authors-data reconstruction; not exact 2025 |
