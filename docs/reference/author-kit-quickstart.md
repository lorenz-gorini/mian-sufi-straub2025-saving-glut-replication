...
| Figure 8: net household-debt stock by wealth group | DINA shares, group liabilities, downstream `a_hh*_hhdSZ`/`d_hh*_hhdSZ` series, and 351 saved direct/pre-round fields in `Yunveilhhd.dta` | The exact full 34-by-27 annual cube cannot be recovered; the saved purpose-built blocks support only an eight-row coarsened reconstruction with explicit clipping/residual-owner limits | Old seven-round benchmark plus a verified closest-feasible 2021-direct/full-inverse reconstruction through 2016 |
